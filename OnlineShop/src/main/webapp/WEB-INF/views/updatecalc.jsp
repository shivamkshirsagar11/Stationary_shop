...
<form action="updatecalc" method="POST">
	<input type="text" name="productTableId" id="id" value="${calc.productTableId }" hidden>
	<div class="mb-3">
    	<label for="pid" class="form-label">Product ID</label>
    	<input type="text" class="form-control" id="pId" name="id" value="${calc.id}" readonly>
  </div>
  <div class="mb-3">
    	<label for="pname" class="form-label">Product Name</label>
    	<input type="text" class="form-control" id="pName" name="name" value="${calc.name }">
  </div>
  <div class="mb-3">
