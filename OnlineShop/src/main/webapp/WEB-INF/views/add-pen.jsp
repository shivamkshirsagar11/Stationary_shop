...
<body>
		<div class="container">
	<h3>Add Pen</h3>
		<form action="addpen" method="post" enctype="multipart/form-data">
...
<div class="form-group">
    <label for="pid">Enter Color</label>
    <input type="text" class="form-control" id="author" placeholder="Color" name="color">
  </div>
